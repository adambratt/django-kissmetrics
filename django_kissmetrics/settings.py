...
if not KISSMETRICS_API_KEY:
    raise Exception('You must define KISSMETRICS_API_KEY '
...
KISSMETRICS_TRACK_INTERNALLY = getattr(  # only supports DB tracking right now
    settings, 'KISSMETRICS_TRACK_INTERNALLY', False)
